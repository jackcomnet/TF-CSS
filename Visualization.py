...
def main():
    ...
    model = torch.load('model_weight/train_MAE_encoder_IQ.pth')
    ...
    print('AMI = ', metrics.adjusted_mutual_info_score(real_target, cluster_target))
    print('ARI = ', metrics.adjusted_rand_score(real_target, cluster_target))
